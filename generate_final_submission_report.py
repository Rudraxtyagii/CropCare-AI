...
def create_report():
    ...
    pdf.cell(95, 8, 'SUPERVISED BY:', 0, 1, 'C')
    
    pdf.set_font('Arial', '', 12)
    pdf.cell(95, 7, 'Rudra Tyagi', 0, 0, 'C')
    pdf.cell(95, 7, 'Department of Computer Science & IT', 0, 1, 'C')
    pdf.cell(95, 7, 'GitHub: Rudraxtyagii', 0, 0, 'C')
    pdf.cell(95, 7, 'KIET Group of Institutions', 0, 1, 'C')
    pdf.ln(20)
